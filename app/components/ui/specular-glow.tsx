...
export const SpecularGlow = ({
  ...
  useEffect(() => {
    ...
    const update = (now: number) => {
      ...
      const targetAngle = pointerAngle != null ? pointerAngle : idleAngle;
  ...
  return (
    <span
      ref={fxRef}
      aria-hidden="true"
      className="pointer-events-none absolute z-10 [&>canvas]:block [&>canvas]:h-full [&>canvas]:w-full"
      style={{ inset: -PAD }}
    />
  );
};
